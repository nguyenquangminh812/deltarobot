...
startP = np.array([[100],[0],[-480]]);
#endP = np.array([[-100],[0],[-450]]);
endP = np.array([[0],[0],[-480]])
...
while True:
     ...
     posYLine = int(origin[0])
     posXLine1 = int(origin[1]-150)
     posXLine2 = int(origin[1]+150)
     img = cv2.line(img,(posXLine1,posYLine),(posXLine2,posYLine),(255,0,0),6)
...
#         sendData(startP,endP);
         for pt in circles[0, :]:
             ...
             posX = int((a-origin[0])*calib)
             posY = int((origin[1]-b)*calib)
             if (posY>-70 and posY < -25)and (posX>-50 and posX < 15):
             #if True:
             	...
             	endP = np.array([[-125-posX],[-posY-297+275],[-480]])
             	sendData(startP,endP);
