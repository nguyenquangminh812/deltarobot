...
while True:
    Xarr = np.array([100, 80, 60 , 40, 20, 0, -20, -40, -60 , -80, -100, -80, -60, -40, -20, 0])
    Yarr = np.array([0, 20, 40, 60 , 80, 100, 80, 60, 40, 20, 0, -20, -40, -60 , -80, -100])
    hommingP =np.array([[0],[0],[-480]]);

    for i in range(Xarr.shape[0]):
        # print(Xarr[i] , Yarr[i])
        targetP = np.array([[Xarr[i]],[Yarr[i]],[-480]])
        sendData(hommingP,targetP)
        time.sleep(5)
